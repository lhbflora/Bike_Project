...
* Bike stations in the midtown and downtown is the relatively popular, that might result from the boom of the Wallstreet finance circle. and the dense of bus and subway stations.
* There also some station placed in Brooklyn. People working in New York City may choose to live in farther place to reduce the burden of monthly housing payment.
## Conclusion
As a good supplement of public traffic, The low cost and convenience rental bike is chosen by millions of people on the way to the bus/subway station to work or just take a leisure riding. According to the data posted, a lot more things can be explore. For example,compare to the last-year-data, how does percentage of the subscribers and costomers change. According to this change how can we adjust the annual and short time price setting. Or what's near the hottest station such that people are willing to rent the bike and to what extent each factor affect the uage. So we can adjust the amount of  bike to be placed in each station. Moreover, in combination with the infrastructure construction, where should we build the new station. 

By further explore this project, the existing system can be optimize in the future to promote the development of this environmentally friendly industry. 
